...
//! textured triangle to present it. Top-left anchored — leftover surface
//! falls on the right/bottom as black margin.
//!
//! Adapted from truce-slint's blit.rs.
...
impl BlitPipeline {
    ...
    /// Draw the texture to a render target, anchored top-left.
    pub fn render(
        &self,
        queue: &wgpu::Queue,
