...
//! Used by spectrum-aware product plugins (Meridian, Equilibrium, …).

use super::{SPECTRUM_BINS, compute_spectrum_bins};
...
impl SnapFFT {
    ...
    ///
    /// Uses [`super::compute_spectrum_bins`]: 4.5 dB/oct pink tilt, **gated** so
